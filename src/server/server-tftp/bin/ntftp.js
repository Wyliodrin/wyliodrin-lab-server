...
var setMainOptions = function(body) {
    ...
    body
        .option({
            ...
            metavar: "SIZE",
            type: Number,
            description: "Size of each data chunk. Valid range: " +
        ...
        .option({
            ...
            metavar: "NUM",
            type: Number,
            description: "Number of retries before aborting the " +
        ...
        .option({
            ...
            type: Number,
            description: "Milliseconds to wait before the next " +
        ...
        .option({
            ...
            metavar: "SIZE",
            type: Number,
            description: "Size of the window. The window will " +
